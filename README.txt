...
skiplist.h contains the actual implementation, with the following functions:
 ...
 skiptests.cpp contains a testing suite verifying everything from basic functionality to more specific edge cases.
